...
export const chapter13: Chapter = {
  ...
  sections: [
    ...
    {
      heading: "13.1 The Fluent Cycle: Read → Understand → Rebuild → Express",
      paragraphs: [
    ...
    {
      heading: "13.2 Decoding at Speed (Input Fluency)",
      paragraphs: [
    ...
    {
      heading: "13.3 Building From Meaning (Output Fluency)",
      paragraphs: [
    ...
    {
      heading: "13.4 The Rebuild Technique",
      paragraphs: [
        "There is a cleaner test for whether you are reading German as German or still routing it through English — rebuild what you just read in your own simpler German. Same meaning, different words. If the rebuild flows, the comprehension was real. If you find yourself silently translating into English before rephrasing, the route is still going through London on its way to Berlin.",
        "Take a line you already know: Berlin schläft — aber nicht ganz. Three rebuilds, each from the same understood meaning, none of them a translation."
      ],
      exampleBlocks: [
        {
    ...
    {
      heading: "13.5 From Copying to Creating",
      paragraphs: [
    ...
    {
      heading: "13.6 Looking Back at the Journey",
      paragraphs: [
