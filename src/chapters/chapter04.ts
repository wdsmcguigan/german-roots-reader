...
export const chapter04: Chapter = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "If you're listening rather than reading, listen for the two posts as each example arrives — the conjugated verb early, then a stretch of cargo, then the closing piece at the very end. That distance you can hear is the Satzklammer."
      ],
      exampleBlocks: [
        {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "First, the trigger. Wenn is a subordinating conjunction, so the whole first clause will have its conjugated verb at the end.",
        "Then the verb pair. That conjugated verb is will (wants), and what it wants is geben — an infinitive, waiting at the back of the Satzklammer the modal verb opens.",
        "Then the cargo. Between will and geben sit four labelled roles: der Mann (nominative subject), seiner Schwester (dative receiver of what will be given), morgen (time adverb), das Buch (accusative — the thing being given). All sitting calmly inside the verb bracket of the subordinate clause.",
        "Then the pivot. The comma. Now the main clause starts. The first clause itself counts as position 1 — the whole when-clause is one big constituent — so the conjugated verb of the main clause arrives immediately in position 2: muss. After that comes er (the subject, nominative), es (the book again, accusative, now a pronoun), vorher (an adverb meaning beforehand), and finally kaufen (the infinitive to buy, closing the main clause's Satzklammer).",
        ...
        "This is what the final chapter means when it looks back and says you now possess structural awareness — cases, word order, prefix verbs, compounds. The first two of those four are now in your hands."
      ]
    },
    {
  ...
  module: {
    ...
    tasks: [
      "Rewrite each of these three English sentences twice in German: once starting with the subject, once starting with a time expression (heute, morgen, gestern). Underline the conjugated verb in each version and check that it lands in position 2. (1) ‘I drink coffee with my sister.’ (2) ‘We watch a film.’ (3) ‘She visits her mother.’",
    ...
    tasksGerman: [
      "Schreibe jeden dieser drei englischen Sätze zweimal auf Deutsch um: einmal mit dem Subjekt am Anfang, einmal mit einer Zeitangabe (heute, morgen, gestern) am Anfang. Unterstreiche jedes Mal das konjugierte Verb und prüfe, ob es in Position 2 steht. (1) „I drink coffee with my sister.“ (2) „We watch a film.“ (3) „She visits her mother.“",
