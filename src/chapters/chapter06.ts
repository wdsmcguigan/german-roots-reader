...
export const chapter06: Chapter = {
  ...
  sections: [
    {
      heading: "6.1 Vocabulary Grows Like a Tree, Not a List",
      paragraphs: [
    ...
    {
      heading: "6.2 How to Study Vocabulary the Efficient Way",
      paragraphs: [
        "Every new root you learn should be studied in layers, not as a single word. Each layer multiplies the value of your effort.",
        "Instead of ten isolated words, you build one structured root family."
      ],
      exampleBlocks: [
        {
          title: "Four Layers for Every Root",
          rows: [
            { left: "1. The Root", right: "Core meaning at its simplest form" },
            { left: "2. Cognates", right: "English relatives and shared ancestry" },
            { left: "3. Compounds", right: "Nouns and adjectives built from the root" },
            { left: "4. Prefix Verbs", right: "Variations in direction, aspect or perspective" }
          ]
        }
      ]
    },
    {
      heading: "6.3 Root Family Templates",
      paragraphs: [
    ...
    },
    {
      ...
      exampleBlocks: [
        {
          title: "A) Create Your Own Root Family",
          rows: [
            { left: "Step 1", right: "Choose a verb you already know: laufen, machen, bringen, stehen, kommen, etc." },
            { left: "Step 2", right: "List at least three compounds or nouns derived from it." },
            { left: "Step 3", right: "List at least three prefix verbs built from the same root." },
            { left: "Result", right: "You have one mini-network instead of eight isolated words." }
          ]
        },
        {
          title: "B) Decode Without a Dictionary",
          rows: [
            { left: "Mitteilung", right: "mit + teilen → something ‘shared with’ → message, communication" },
            { left: "Vorstellung", right: "vor + stellen → put in front → idea; performance; introduction" },
            { left: "Entdeckung", right: "ent + decken → un-covering → discovery" },
            { left: "Gegenstand", right: "gegen + Stand → that which ‘stands against’ → object" }
          ]
        }
      ]
    },
