...
export const chapter09: Chapter = {
  ...
  sections: [
    {
      heading: "9.1 Why Familiarity Lies",
      paragraphs: [
    ...
    {
      heading: "9.2 How Meanings Drift",
      paragraphs: [
    ...
    {
      heading: "9.3 Same Root, Different Destiny — The False Friend Gallery",
      paragraphs: [
        "Most false friends fall into one of a few patterns. Below is the gallery, organised by what kind of trick each pair is playing."
      ],
      exampleBlocks: [
        {
    ...
    {
      heading: "9.4 Brief: An Elegant Drift",
      paragraphs: [
    ...
    {
      heading: "9.6 Closing Insight for Chapter 9",
      paragraphs: [
