...
export const chapter09: Chapter = {
  ...
  sections: [
    {
      heading: "9.1 The Most Powerful Feature in the Language",
      paragraphs: [
    ...
    {
      heading: "9.2 How Compounds Are Structured",
      paragraphs: [
        "The rule is unfair in its simplicity. The last word tells you what the thing actually is; everything in front of it narrows what kind. So you read compounds backwards from how you write them — find the head on the right, then layer the modifiers leftward.",
        "Handschuh is a Schuh first (a shoe), Hand second (for the hand). Hauptbahnhof is a Hof (yard) — specifically a Bahnhof (train yard), specifically the Haupt one (the main).",
        "Native readers don't consciously do this; they've memorised the most common heads and the modifiers slot in. You can fake it for a while by reading from the right."
      ],
      exampleBlocks: [
        {
    ...
    {
      heading: "9.3 Compressed Ideas in One Word",
      paragraphs: [
    ...
    {
      heading: "9.4 A Root Cluster: WORT (Word)",
      paragraphs: [
    ...
    {
      heading: "9.6 Creative Word Construction",
      paragraphs: [
