...
export const appendixB: Chapter = {
  ...
  sections: [
    ...
    {
      heading: "B.2 Separable vs Inseparable: Two Behaviors",
      paragraphs: [
    ...
    {
      heading: "B.3 Inseparable Prefixes in Depth",
      paragraphs: [
    ...
    {
      heading: "B.4 Separable Prefixes as German Phrasal Verbs",
      paragraphs: [
    ...
    {
      heading: "B.5 Suffix Logic (Meaning from Endings)",
      paragraphs: [
    ...
    {
      heading: "B.6 Combining Roots, Prefixes and Suffixes",
      paragraphs: [
