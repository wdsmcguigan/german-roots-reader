...
const App: React.FC = () => {
  ...
  return (
    <div className={rootClasses}>
      ...
      {/* Mobile: Practice Module — inline below header, same animation as sidebar */}
      {!isLargeScreen && active.module && (
        <div
          className={
            "overflow-hidden transition-all duration-500 ease-in-out border-b " +
            (darkMode ? "border-slate-800 bg-[#050316]/95" : "border-slate-200/80 bg-white/95") +
            (rightSidebarOpen ? " max-h-[3000px] opacity-100" : " max-h-0 opacity-0")
          }
        >
      ...
      <main className="mx-auto flex max-w-[2000px] flex-col gap-6 px-4 py-6 lg:flex-row lg:px-6 lg:py-10">
        ...
        <aside
          className={
            "w-full overflow-hidden transition-all duration-500 ease-in-out lg:shrink-0 " +
            (leftSidebarOpen
              ? "max-h-[2000px] opacity-100 mb-4 lg:mb-0 lg:w-60 lg:max-h-none"
              : "max-h-0 opacity-0 mb-0 lg:w-0 lg:max-h-none")
          }
        >
          <div
            className={
